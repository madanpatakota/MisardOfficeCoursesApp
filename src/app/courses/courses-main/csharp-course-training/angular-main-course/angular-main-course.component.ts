...
With ongoing community support and real-world enterprise use, Angular developers remain in high demand globally.`,
  ...
  chaptersList = [
    {
      ...
      ProjectGitHubURL: 'https://github.com/madanpatakota/AngularBasicsApp',
      lessons: [
        {
          id: 1,
    ...
    },
    {
      ...
      ProjectGitHubURL:
        'https://github.com/madanpatakota/AngularBasicsApp/tree/Second-Class',
    ...
    },
    {
      ...
      ProjectGitHubURL:
        'https://github.com/madanpatakota/AngularBasicsApp/tree/ThirdClass',
    ...
    },
    {
      ...
      ProjectGitHubURL:
        'https://github.com/madanpatakota/AngularDataCommunication',
    ...
    },
    {
      ...
      ProjectGitHubURL: 'https://github.com/madanpatakota/3.AngularServicesApp',
      lessons: [
        {
          id: 1,
          name: 'Services',
    ...
    },
    {
      ...
      ProjectGitHubURL: 'https://github.com/madanpatakota/4.AngularRoutingApp',
    ...
    },
    {
      ...
      ProjectURL: '',
      ProjectGitHubURL: 'https://github.com/madanpatakota/AngularForms',
    ...
    },
    {
      ...
      ProjectUrl: '',
      ProjectGitHubURL: 'https://github.com/madanpatakota/AngularHttp',
      lessons: [
        {
          id: 1,
  ...
  showAccessDenied() {
    // If URL is null/undefined → show "Access Denied"
    Swal.fire({
      title: `
    <div style="font-size:22px; font-weight:700; color:#b71c1c;">
      <i class="bi bi-shield-lock-fill" style="font-size:30px; color:#b71c1c;"></i>
